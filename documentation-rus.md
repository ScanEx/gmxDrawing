...
------|------|:---------:|-----------
add|`add(<L.GeoJSON, L.Polyline, L.Polygon, L.Rectangle, L.GmxDrawing.Feature, L.MultiPolygon, L.MultiPolyline, L.Marker> object, <Feature options> options? )`|`<L.GmxDrawing.Feature>`| Добавить редактируемый объект.
